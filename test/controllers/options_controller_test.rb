...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { question: @option.question, selection_count: @option.selection_count, title: @option.title }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { question: @option.question, selection_count: @option.selection_count, title: @option.title }
    assert_redirected_to option_path(assigns(:option))
  end
