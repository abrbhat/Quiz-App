...
class ViewersControllerTest < ActionController::TestCase
  ...
  test "should create viewer" do
    assert_difference('Viewer.count') do
      post :create, viewer: { name: @viewer.name, questions_viewed: @viewer.questions_viewed, quizzes_viewed: @viewer.quizzes_viewed }
    end
  ...
  test "should update viewer" do
    patch :update, id: @viewer, viewer: { name: @viewer.name, questions_viewed: @viewer.questions_viewed, quizzes_viewed: @viewer.quizzes_viewed }
    assert_redirected_to viewer_path(assigns(:viewer))
  end
